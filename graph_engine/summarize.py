...
LLM_MODEL = "qwen2.5:14b"  # 使用你效果最好的模型
...
def generate_community_summaries():
    ...
    llm = OllamaLLM(model=LLM_MODEL, base_url="http://172.28.16.1:11434")
    ...
    for cid in community_ids:
        try:
            ...
            # B. 调用 LLM 生成摘要
            prompt = PromptTemplate.from_template(COMMUNITY_SUMMARIZE_PROMPT)
            chain = prompt | llm
